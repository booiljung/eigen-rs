...
impl GemmKernel for AsmFmaKernelF32 {
    type Elem = f32;
    const MR: usize = 24; // Increased MR for better register usage (if possible, but AVX2 has 16 YMMs. 24 rows need 3 regs per col? 
    ...
    unsafe fn microkernel(
        ...
        let mut c00: __m256; let mut c01: __m256; let mut c02: __m256;
        let mut c03: __m256; let mut c04: __m256; let mut c05: __m256;
        let mut c10: __m256; let mut c11: __m256; let mut c12: __m256;
        let mut c13: __m256; let mut c14: __m256; let mut c15: __m256;
...
impl GemmKernel for AsmFmaKernelF64 {
    ...
    unsafe fn microkernel(
        ...
        let mut c00: __m256d; let mut c01: __m256d; let mut c02: __m256d; let mut c03: __m256d;
        let mut c10: __m256d; let mut c11: __m256d; let mut c12: __m256d; let mut c13: __m256d;
