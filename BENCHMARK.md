...
# Run with randomized sizes (Prevent overfitting)
...
> **Strict Rule**: Do not manually create or rename these files. The benchmark report must be generated by the `verify_perf.py` script to ensure data integrity and format compliance.
