...
fn test_matrix_determinant_differential() {
    ...
    *m3.get_mut(0, 0).unwrap() = 1.0;
    *m3.get_mut(0, 1).unwrap() = 2.0;
    *m3.get_mut(0, 2).unwrap() = 3.0;
    *m3.get_mut(1, 0).unwrap() = 0.0;
    *m3.get_mut(1, 1).unwrap() = 1.0;
    *m3.get_mut(1, 2).unwrap() = 4.0;
    *m3.get_mut(2, 0).unwrap() = 5.0;
    *m3.get_mut(2, 1).unwrap() = 6.0;
    *m3.get_mut(2, 2).unwrap() = 0.0;
