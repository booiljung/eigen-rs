...
fn test_spline_linear_eval() {
    ...
    *ctrl.get_mut(0, 0).unwrap() = 0.0;
    *ctrl.get_mut(1, 0).unwrap() = 0.0;
    *ctrl.get_mut(0, 1).unwrap() = 1.0;
    *ctrl.get_mut(1, 1).unwrap() = 1.0;
...
fn test_spline_quadratic_eval() {
    ...
    *ctrl.get_mut(0, 0).unwrap() = 0.0;
    *ctrl.get_mut(1, 0).unwrap() = 0.0;
    *ctrl.get_mut(0, 1).unwrap() = 0.5;
    *ctrl.get_mut(1, 1).unwrap() = 1.0;
    *ctrl.get_mut(0, 2).unwrap() = 1.0;
    *ctrl.get_mut(1, 2).unwrap() = 0.0;
    ...
    assert!(
        (res.get(0, 0).unwrap() - 0.5).abs() < 1e-10,
        "X val: {}",
        res.get(0, 0).unwrap()
    );
    assert!(
        (res.get(1, 0).unwrap() - 0.5).abs() < 1e-10,
        "Y val: {}",
        res.get(1, 0).unwrap()
    );
}
...
fn test_spline_robustness() {
    ...
    // (0,0), (1,1), (2,2)
    *points_collinear.get_mut(0, 0).unwrap() = 0.0;
    *points_collinear.get_mut(1, 0).unwrap() = 0.0;
    *points_collinear.get_mut(0, 1).unwrap() = 1.0;
    *points_collinear.get_mut(1, 1).unwrap() = 1.0;
    *points_collinear.get_mut(0, 2).unwrap() = 2.0;
    *points_collinear.get_mut(1, 2).unwrap() = 2.0;
    ...
    // (0,0) -> (1,1) -> (1,0) -> (0,0)
    *points_loop.get_mut(0, 0).unwrap() = 0.0;
    *points_loop.get_mut(1, 0).unwrap() = 0.0;
    *points_loop.get_mut(0, 1).unwrap() = 1.0;
    *points_loop.get_mut(1, 1).unwrap() = 1.0;
    *points_loop.get_mut(0, 2).unwrap() = 1.0;
    *points_loop.get_mut(1, 2).unwrap() = 0.0;
    *points_loop.get_mut(0, 3).unwrap() = 0.0;
    *points_loop.get_mut(1, 3).unwrap() = 0.0;
