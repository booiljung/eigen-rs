...
mod tests {
    ...
    fn test_sparse_qr_identity() {
        ...
        let mut mat =
            SparseMatrix::<f64>::new(3, 3, eigen_rs::core::sparse::StorageOrder::ColMajor);
    ...
    fn test_sparse_qr_rectangular_least_squares() {
        ...
        let mut mat =
            SparseMatrix::<f64>::new(3, 2, eigen_rs::core::sparse::StorageOrder::ColMajor);
        mat.set_from_triplets(triplets);
    ...
    fn test_sparse_qr_tridiagonal() {
        ...
        let mut mat =
            SparseMatrix::<f64>::new(n, n, eigen_rs::core::sparse::StorageOrder::ColMajor);
        mat.set_from_triplets(triplets);
        ...
        let b =
            Matrix::<f64, DynamicStorage<f64>>::from_vec(n, 1, vec![1.0, 0.0, 0.0, 1.0]).unwrap();
