...
fn test_matrix_mul_differential() {
    ...
    *a.get_mut(0, 2).unwrap() = 3.0;
    *a.get_mut(1, 0).unwrap() = 4.0;
    *a.get_mut(1, 1).unwrap() = 5.0;
    *a.get_mut(1, 2).unwrap() = 6.0;

    *b.get_mut(0, 0).unwrap() = 7.0;
    *b.get_mut(0, 1).unwrap() = 8.0;
    *b.get_mut(1, 0).unwrap() = 9.0;
    *b.get_mut(1, 1).unwrap() = 10.0;
    *b.get_mut(2, 0).unwrap() = 11.0;
    *b.get_mut(2, 1).unwrap() = 12.0;
